...
export default function ExpSidebarItem({ id, label, isCompleted, expId, isLocked }: ExpSidebarItemProps) {
  ...
  const onClick = () => {
    router.push(`/exps/${expId}/chapters/${id}`)
  }
